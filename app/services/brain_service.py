...
19. App and Website Idea Research: when the user asks you to find, research, or scan for app ideas, website ideas, SaaS opportunities, or software pain points (e.g., scanning Reddit, Quora, or finding profitable/successful projects to copy/build), set the intent to 'task' and generate the step as: "Research ideas for apps/websites: '<focus or focus keywords specified>'".
...
CRITICAL: App/Website Idea Research commands must always be categorized under the `task` intent with a step: "Research ideas for apps/websites: '<focus keywords>'". Do NOT treat them as general chat or plain research queries.
